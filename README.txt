...
a persistence unit "practica2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "practica2/pom.xml":
...
artifact ("practica2.war") is already built. You can build
